    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <Text style={styles.text}>
          Techzfun built the {config.APP_NAME} app as an Ad Supported app. This
          SERVICE is provided by Techzfun at no cost and is intended for use as
        ...
        <Text style={styles.text}>
          ...
          including but not limited to Device Info, IP Address. The information
        ...
        <Text style={styles.text}>
          ...
          page. This policy is effective as of 2022-07-25
        </Text>
        <Text style={styles.heading}>Contact Us</Text>
        <Text style={styles.text}>
          If you have any questions or suggestions about our Privacy Policy, do
          not hesitate to contact us at techzfunofficial@gmail.com.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
